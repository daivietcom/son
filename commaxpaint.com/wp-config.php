...
define('DB_NAME', 'commaxpaint.com');
...
define('WP_SITEURL', 'http://commaxpaint.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://commaxpaint.local'); // tên domain ở cuối ko có dấu /
