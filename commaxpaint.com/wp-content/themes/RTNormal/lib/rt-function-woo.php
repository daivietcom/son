...
if (  ! function_exists( 'woocommerce_template_loop_product_title_viewct' ) ) {
  /**
   * Show the product title in the product loop. By default this is an H3.
   */
  function woocommerce_template_loop_product_title_viewct() {
    echo '<div class="viewct"><a href="' . get_permalink() . '"  title="' . get_the_title() . '">Xem chi tiết</a></div>';
  }
}
...
add_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_product_title_viewct', 7 );
