...
define('WP_SITEURL', 'http://campercolor.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://campercolor.local'); // tên domain ở cuối ko có dấu /
