...
define('WP_SITEURL', 'http://kismaxpaint.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://kismaxpaint.local'); // tên domain ở cuối ko có dấu /
