...
?>
											<strong><a href="<?php echo $exclude_link; ?>" title="<?php echo esc_attr( sprintf( __( 'Exclude &#8220;%s&#8221;' ), sanitize_title($intrusion->name) ) ); ?>"><?php echo esc_html(sanitize_title( $intrusion->name) ); ?></a></strong>
...
<?php
										...
										case 'page':
											echo "<div class='intrusion_content'>".wp_kses(esc_url( $intrusion->page ), $allowed).'</div>';
											break;
										...
										case 'ip':
											echo sanitize_text_field(esc_html( $intrusion->ip )). ' <br/> '; //hassan
