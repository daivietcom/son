    ...
    <div class="content-sidebar-wrap">
        ...
        <?php if ( !empty ( $slugproduct ) ) : ?>
            <div class="product-news-wrap">
                ...
                ?>
                <h2 class="heading">
                    <a class="item" href="<?php echo get_productcat_link($idpro); ?>" title="<?php echo get_productcat_name($idpro);?>">
                        <?php echo get_productcat_name($idpro); ?>
                    </a>

                    <a class="views-all" href="<?php echo get_productcat_link($idpro); ?>" title="<?php echo get_productcat_name($idpro);?>">
                       <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Xem tất cả 
                    </a>
                </h2>
                <div class="clear"></div>
        ...
        <?php if ( !empty ( $slugpost ) ) : ?>
            <div class="news-wrap">
                ...
                ?>
                    <h2 class="heading">
                        <a class="item" href="<?php echo get_category_link($idpost); ?>" title="<?php echo get_cat_name($idpost);?>">
                            <?php echo get_cat_name($idpost); ?>
                        </a>
                       <a class="views-all" href="<?php echo get_category_link($idpost); ?>" title="<?php echo get_cat_name($idpost);?>">
                               <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Xem tất cả
                        </a>
                    </h2>
                    <div class="clear"></div>
                    <div class="news-list">
                    <?php echo do_shortcode('[rtblog style="5" posts_per_page="' . $numpost . '" categories="' . $idpost . '" custom_text="Xem Thêm"]'); ?>
                    </div><!--News-List-->
