...
define('WP_SITEURL', 'http://laztupaint.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://laztupaint.local'); // tên domain ở cuối ko có dấu /
