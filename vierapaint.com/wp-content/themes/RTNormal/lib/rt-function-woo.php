...
function add_single_product_widget() {
...
if (  ! function_exists( 'woocommerce_template_loop_product_view_title' ) ) {
  /**
   * Show the product title in the product loop. By default this is an H3.
   */
  function woocommerce_template_loop_product_view_title() {
    echo '<a class="view-title" href="' . get_permalink() . '"  title="' . get_the_title() . '">Xem chi tiết</a>';
    echo '<a rel="nofollow" href="' . get_permalink() . '" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Đặt hàng</a>';
  }
}
...
add_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_product_view_title', 7 );
