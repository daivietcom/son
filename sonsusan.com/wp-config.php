...
define('WP_SITEURL', 'http://sonsuisan.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://sonsuisan.local'); // tên domain ở cuối ko có dấu /
