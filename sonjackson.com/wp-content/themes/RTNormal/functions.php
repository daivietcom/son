...
function add_raothue_link(){
	echo "<p id='credit-link'>
			...
			<strong> © 2020 sonjackcom.com  . Thiết kế và phát triển bởi <a style='color: #4D91EA' target='_blank' href='https://dvchat.vn/'>DVChat</a> </strong>
			</a>
		</p>";
...
function add_search(){
	echo "<div class='search-home'><div class='wrap'>";
		dynamic_sidebar('search');
	echo "</div></div>";
}
add_action('genesis_before_content','add_search');