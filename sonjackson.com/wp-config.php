...
define('WP_SITEURL', 'http://sonjackson.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://sonjackson.local'); // tên domain ở cuối ko có dấu /
