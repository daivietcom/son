...
define('WP_SITEURL', 'http://maxsupaint.local/'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://maxsupaint.local/'); // tên domain ở cuối ko có dấu /
