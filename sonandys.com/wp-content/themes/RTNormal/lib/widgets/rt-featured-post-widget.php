 ...
 * @package Genesis\Widgets
 */
class RT_Featured_Post extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'rt-featured-post', __( 'RT - Danh sách bài viết', 'genesis' ), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['extra_num'] ) ) {
			...
			$query_args = array(
			'post_type' => 'tin-tuc', // change postype ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			'tax_query' => array(
                array(
                    'taxonomy' => 'danhmuc',
                    'field' => 'id',
		...
		<div class="genesis-widget-column">
			...
			<div class="genesis-widget-column-box genesis-widget-column-box-top">
				...
				<p>
					...
					$categories_args = array(
						...
						'hide_empty'      => '0',
						'taxonomy'		  => 'danhmuc' //change taxonomy  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
					);
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'posts_offset' ); ?>"><?php _e( 'Vị trí bắt đầu', 'genesis' ); ?>:</label>
				...
				<!-- <p>
					<label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php _e( 'Sắp xếp theo', 'genesis' ); ?>:</label>
					<select id="<?php echo $this->get_field_id( 'orderby' ); ?>" name="<?php echo $this->get_field_name( 'orderby' ); ?>">
						<option value="date" <?php selected( 'date', $instance['orderby'] ); ?>><?php _e( 'Ngày', 'genesis' ); ?></option>
						<option value="title" <?php selected( 'title', $instance['orderby'] ); ?>><?php _e( 'Tiêu đề', 'genesis' ); ?></option>
						<option value="parent" <?php selected( 'parent', $instance['orderby'] ); ?>><?php _e( 'Danh mục cha', 'genesis' ); ?></option>
						<option value="ID" <?php selected( 'ID', $instance['orderby'] ); ?>><?php _e( 'ID', 'genesis' ); ?></option>
						<option value="comment_count" <?php selected( 'comment_count', $instance['orderby'] ); ?>><?php _e( 'Số bình luận', 'genesis' ); ?></option>
						<option value="rand" <?php selected( 'rand', $instance['orderby'] ); ?>><?php _e( 'Ngẫu nhiên', 'genesis' ); ?></option>
					</select>
				</p> 

				<p>
					<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php _e( 'Thứ tự', 'genesis' ); ?>:</label>
					<select id="<?php echo $this->get_field_id( 'order' ); ?>" name="<?php echo $this->get_field_name( 'order' ); ?>">
						<option value="DESC" <?php selected( 'DESC', $instance['order'] ); ?>><?php _e( 'Giảm dần (3, 2, 1)', 'genesis' ); ?></option>
						<option value="ASC" <?php selected( 'ASC', $instance['order'] ); ?>><?php _e( 'Tăng dần (1, 2, 3)', 'genesis' ); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'exclude_displayed' ); ?>"><?php _e( 'Loại trừ các bài viết đã hiển thị ?', 'genesis' ); ?></label>
				</p>
				-->
			</div>
			...
			<div class="genesis-widget-column-box">
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'show_gravatar' ); ?>"><?php _e( 'Hiển thị ảnh tác giả', 'genesis' ); ?></label>
				</p>
			...
			-->
			<div class="genesis-widget-column-box" style="padding-bottom: 14px;">
		...
		<div class="genesis-widget-column genesis-widget-column-right">
			...
			<div class="genesis-widget-column-box genesis-widget-column-box-top">
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Hiện tiêu đề bài viết', 'genesis' ); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'show_byline' ); ?>"><?php _e( 'Hiện thông tin bài viết', 'genesis' ); ?></label>
				...
				<p>
					...
					<select id="<?php echo $this->get_field_id( 'show_content' ); ?>" name="<?php echo $this->get_field_name( 'show_content' ); ?>">
						<option value="content" <?php selected( 'content', $instance['show_content'] ); ?>><?php _e( 'Nội dung đầy đủ', 'genesis' ); ?></option>
						<option value="excerpt" <?php selected( 'excerpt', $instance['show_content'] ); ?>><?php _e( 'Nội dung tóm tắt', 'genesis' ); ?></option>
			...
			<div class="genesis-widget-column-box">
				...
				<p><?php _e( 'Tùy chỉnh các bài viết khác cùng chuyên mục', 'genesis' ); ?>:</p>

				<p>
					<label for="<?php echo $this->get_field_id( 'extra_title' ); ?>"><?php _e( 'Tiêu đề', 'genesis' ); ?>:</label>
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'extra_num' ); ?>"><?php _e( 'Số bài viết hiển thị', 'genesis' ); ?>:</label>
