...
define('WP_SITEURL', 'http://sonandys.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://sonandys.local'); // tên domain ở cuối ko có dấu /
