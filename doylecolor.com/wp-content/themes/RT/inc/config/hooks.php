...
function rt_header_script() {
	global $rt_option;
	$rt_head_code = $rt_option['rt_header_script'];
	if(!empty($rt_head_code)) {
		foreach($rt_head_code as $rt_head) :	
			echo $rt_head['header_script_value'];
		endforeach;
	}
}
...
function rt_footer_script() {
	global $rt_option;
	$rt_head_code = $rt_option['rt_footer_script'];
	if(!empty($rt_head_code)) {
		foreach($rt_head_code as $rt_head) :	
			echo $rt_head['footer_script_value'];
		endforeach;
	}
}
/**
