  ...
  $options[]    = array(
      ...
      'fields'    => array(
        ...
        array(
          'type'    => 'notice',
          'class'   => 'info',
          'content' => 'Chọn bài viết ở trang chủ',
        ),
        array(
          'id'             => 'page_home',
          'type'           => 'select',
          'title'          => 'Chọn trang hiển thị',
          'options'        => 'page',
          'query_args'    => array(
            'sort_order'  => 'ASC',
        ...
        array(
          ...
          'fields'          => array(
            array(
              'id'    => 'product_cat_title', 
              'type'  => 'text',
              'title' => 'Tiêu đề chuyên mục hiển thị',
            ),
            array(
              'id'             => 'product_cat_sub',
              'type'           => 'select',
     ...
     'sections'  => array(
                ...
                'fields'    =>  array(
                  ...
                  'fields'    =>  array(
                    ...
                    // setup image for ggle
                    array(
                      'type'    => 'notice',
                      'class'   => 'info',
                      'content' => 'Tùy chỉnh kích thước hình ảnh',
                    ),       
                    array(
                      'id'    => 'on_cart_image',
                      'type'    => 'switcher',
                      'title'    => 'Bật/ tắt tùy chỉnh hình ảnh',
                      'default'    => false,
                    ),
                    array(
                      'id'    => 'on_cart_image_width',
                      'type'    => 'text',
                      'title'    => 'Chiều rộng ảnh',
                      'default'    => false,
                      'attributes' => array(
                          'style'    => 'width: 50px;',
                        ),
                      'dependency' => array( 'on_cart_image', '==', 'true' ),
                    ),
                    array(
                      'id'    => 'on_cart_image_heigh',
                      'type'    => 'text',
                      'title'    => 'Chiều cao ảnh',
                      'default'    => false,
                      'attributes' => array(
                ...
                array(
                  ...
                  'fields'    =>  array(
                    ...
                    array(
                      ...
                      'default'      => '<a rel="nofollow" target="_blank" href="https://dvchat.vn/" title="thiet ke website">Design by DV chat</a>',
                    ),
                  ),
                  ),
                // Code
