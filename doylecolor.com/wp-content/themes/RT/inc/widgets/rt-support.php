								...
								if ( !empty( $phone ) ) {
									...
									if ( in_array( $giaodien, array( 3,5,6 ) ) ) {
										echo"<div class='socical'>";
											 if ( !empty( $skype ) ): ?>
												<a href="<?php echo 'skype:'.$instance['supporter_'.$j.'_skype'].'?chat'; ?>">
													<img src="<?php echo $url.'/assets/css/images/icon-sky.png' ?>" style="border: none; width:auto; height: 24px;" width="100" height="24" alt="My status" />
												</a>
											<?php endif ?>
											<?php
											 if ( !empty( $zalo ) ): ?>
												<a href="<?php echo 'zalo:'.$instance['supporter_'.$j.'_zalo'].'?chat'; ?>">
													<img src="<?php echo $url.'/assets/css/images/icon-zl.png' ?>" style="border: none; width:auto; height: 24px;" width="100" height="24" alt="My status" />
												</a>
											<?php endif ?>
											<?php
											 if ( !empty( $viber ) ): ?>
												<a href="<?php echo 'viber:'.$instance['supporter_'.$j.'_viber'].'?chat'; ?>">
													<img src="<?php echo $url.'/assets/css/images/icon-vb.png' ?>" style="border: none; width:auto; height: 24px;" width="100" height="24" alt="My status" />
												</a>
											<?php endif ?>
											<?php echo "</div>" ; ?>
						<?php
