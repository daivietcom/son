			...
			<div class="new-list">
                <?php
                    ...
                    <div class="news-post">
                          ...
                          <div class="date-time">
                              <span><i class="fa fa-user" aria-hidden="true"></i> By :<?php echo get_the_author();?></span> 
                              <span><i class="fa fa-eye" aria-hidden="true"></i><?php echo get_post_views (get_the_ID());?></span>
                    ...
                    <?php
                        endwhile; 
						            do_action('rt_after_content_post_pagenavi');
                        wp_reset_postdata();
			     	?>
			    </div>
         </div><!--End #news-wrap-->
