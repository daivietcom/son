			...
			<div class="news-post news-post-big news-post-<?php echo $i; ?>" >
				<div class="post-thumbnail">
					<a href="<?php the_permalink(); ?>">
						<?php if(has_post_thumbnail()) the_post_thumbnail("large",array("alt" => get_the_title()));
                    			else echo $no_thumb; ?>
					</a>
				</div>
				<div class="content">
				    <a href="<?php the_permalink();?>" class="news-title" title="<?php the_title();?>"><?php echo the_title(); ?></a>
					<?php the_content_limit('200','Xem thêm <i class="fa fa-angle-double-right" aria-hidden="true"></i>');?>
				</div>
			</div>
		</div>
