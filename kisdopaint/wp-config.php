...
define('WP_SITEURL', 'http://kisdopaint.local'); // tên domain ở cuối ko có dấu /
define('WP_HOME', 'http://kisdopaint.local'); // tên domain ở cuối ko có dấu /
